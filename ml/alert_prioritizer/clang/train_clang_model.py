...
DATA_FILE = "data/processed/alert_prioritizer/clang/clang_alert_features.csv"
MODEL_OUTPUT = "models/alert_prioritizer/clang/clang_priority_model.pkl"
RESULTS_OUTPUT = "reports/alert_prioritizer/clang/model_comparison.csv"
